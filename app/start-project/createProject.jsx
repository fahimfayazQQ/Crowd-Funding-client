      ...
      <Fade>
        ...
        <ul className="lg:w-1/2 mx-auto lg:my-10">
          <li className="py-3 text-sm lg:text-xl flex">
            <span className="font-semibold pr-2">01</span>
            Listen to what they say about you
          </li>
          <li className="py-3 text-sm lg:text-xl flex">
            <span className="font-semibold pr-2">02</span>
            Randomised words which don&apos;t look even slightly believable.
          </li>
          <li className="py-3 text-sm lg:text-xl flex">
            <span className="font-semibold pr-2">03</span>
            Lorem Ipsum generators on the Internet tend to repeat predefined
            chunks
          </li>
          <li className="py-3 text-sm lg:text-xl flex">
            <span className="font-semibold pr-2">04</span>
