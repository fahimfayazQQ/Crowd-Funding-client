  ...
  return (
    <div className="max-w-screen-xl px-5 mx-auto pt-20">
      ...
      <div className="mb-5">
        ...
        printing and typesetting industry. Lorem Ipsum been the industry&apos;s
        standard dummy text ever since the 1500s, when an unknown printegalley
        of type and scrambled it to make a type specimen book.Lorem Ipsum is
        simply dummy text of the printing and typesetting industry. Lorem Ipsum
        been the industry&apos;s standard dummy text ever since the 1500s, when
        an unknown printegalley of type and scrambled it to make a type specimen
        book.
      </div>
      <div className="mb-5">
        Lorem Ipsum is simply dummy text of the printing and typesetting
      ...
      <div className="flex flex-col lg:flex-row justify-between mt-20">
        <div className="lg:w-1/3">
          ...
          <div className="mb-5">
            ...
            typesetting industry. Lorem Ipsum been the industry&apos;s standard
            dummy text ever since the 1500s, when an unknown printegalley of
