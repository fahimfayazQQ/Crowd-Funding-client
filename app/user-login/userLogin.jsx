        ...
        <div className="w-full lg:bg-admin-secondary-color flex justify-center items-center  rounded-tr-2xl rounded-br-2xl">
          <div className="rounded-xl w-[40vh] text-white">
            ...
            <div className="text-center my-6">
              ...
              <p className="pt-2 pb-4  text-sm">Login to access your account</p>
            </div>
              ...
              /> */}
                ...
                <div className="mb-6">
                  <Link href={"../user"}>
                    <button
                      type="submit"
                      className="w-full p-3 font-medium bg-white text-black hover:bg-gray-200 rounded-md focus:outline-none"
                    >
                      Log in
                    </button>
                  </Link>
