      ...
      <div className="flex flex-col-reverse lg:flex-row justify-evenly items-center overflow-hidden">
        <div className="w-11/12 lg:w-1/4 my-auto">
          <Fade direction="left" triggerOnce>
            ...
            <div className="w-11/12 bg-gradient-to-tl from-[#5143F6] via-indigo-400 to-[#5143F6] text-white tracking-widest text-sm text-center shadow-xl rounded-md py-4 px-4">
              <span className="text-2xl font-bold">100%</span> Safe to Use
            </div>
          </Fade>
        </div>
        <Fade direction="right" triggerOnce>
          <div className="flex-col shadow-lg p-5 rounded-3xl bg-white mb-14 lg:mb-5 relative">
