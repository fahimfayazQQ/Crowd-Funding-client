  ...
  return (
    <div className="lg:w-9/12 h-full mx-auto p-4 lg:p-20">
      <div className="flex items-center gap-5 relative">
        <Image src={ProfilePic} alt="img" className="lg:absolute -left-52" />
        <div>
      ...
      <div className="w-full border my-10"></div>
      <div className="lg:w-1/2 flex flex-wrap justify-between">
        <div className="w-[6rem] lg:w-[10rem] flex flex-col m-10">
