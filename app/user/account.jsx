...
const Account = () => {
  return (
    <div className="w-11/12 h-screen lg:h-[83vh] flex justify-center items-center mx-auto lg:my-20 bg-admin-secondary-color bg-opacity-60 rounded-2xl text-white">
      <div className="">
