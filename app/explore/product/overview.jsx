...
const Overview = () => {
  return (
    <div className="max-w-screen-xl mx-auto my-20 p-10 rounded-xl shadow-lg">
      <div className="text-2xl text-cneter">Paragraphs What this handout is about</div>
      <div>
      ...
      <Image src={Image3} alt="" className="w-full my-5"/>
      <div>
        ...
        appearance do not determine whether a section in a paper is a paragraph. <br />
        ...
        because it controls what happens in the rest of the paragraph. <br /> How do I
